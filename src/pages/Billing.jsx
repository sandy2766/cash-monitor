...
export default function Billing() {
  ...
  // Group by client, sorted by most recent date desc
    ...
    <div className="min-h-screen bg-gray-50 max-w-md mx-auto">
      ...
      {tab === 'ledger' && (
        <div className="p-4 space-y-3">
          <div className="bg-violet-50 border border-violet-100 rounded-xl px-3.5 py-2.5 flex gap-2 items-center text-xs text-violet-700">
            👁 View only — Billing cannot make entries
          </div>
